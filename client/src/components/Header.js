...
const Header = () => {
  ...
  <ul className="dropdown-menu">
    <li><Link className="dropdown-item text-white" to="#">bkjbd</Link></li>
    <li><Link className="dropdown-item text-white" to="#">bjkcd</Link></li>
    <li><Link className="dropdown-item text-white" to="#">bshdc</Link></li>
  </ul>
</div>
             </div>
